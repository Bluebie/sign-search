...
rsync -avr --delete-after --exclude="/node_modules" --exclude="/.git" --exclude="/.dat" --exclude="/datasets" ~/Sync/sign-search/* -e ssh web@auslan.fyi:/home/web/beta.find.auslan.fyi
