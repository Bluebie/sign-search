...
class SearchEngine {
  ...
  async query (queryText) {
    ...
    // temporary, hide auslan-anywhere during deployment
    if (!positiveTags.includes('auslan-anywhere') && !negativeTags.includes('auslan-anywhere')) {
      negativeTags.push('auslan-anywhere')
    }
