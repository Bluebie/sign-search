...
class DocumentTemplate {
  ...
  toBodyHTML() {
    ...
    return html`
    <body class="${this.body.getPageType()}" ${Object.entries(this.body.getData()).map(([k,v])=> html` data-${k}="${v}"`)}>

      ${raw(fs.readFileSync(appRootPath.resolve('style/assets/icomoon/symbol-defs.svg')))}
