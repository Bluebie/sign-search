...
},{"../search-library/library-web":6,"../util":10,"../vector-library/library":11,"../vector-utilities":12,"./query":2}],2:[function(require,module,exports){
...
},{"../vector-utilities":12}],3:[function(require,module,exports){
...
},{"/Users/phx/Sync/sign-search/node_modules/nanohtml/lib/append-child.js":31}],4:[function(require,module,exports){
const html={};class SearchResultPanel{constructor(t={}){this.config=t,this.config.mediaIndex=this.config.mediaIndex||0,this.result=t.result||null,this.forcedWarnings=[]}setData(t){this.result=t,this.config.onChange&&this.config.onChange(this)}addWarning({type:t,text:e}){this.forcedWarnings.push({type:t,text:e}),this.config.onChange&&this.config.onChange(this)}removeWarning(t){this.forcedWarnings=this.forcedWarnings.filter(e=>e.type!=t),this.config.onChange&&this.config.onChange(this)}toHTML(){return this.result&&this.result.isFetched()?this.toPopulatedHTML():this.toPlaceholderHTML()}getWarnings(){let t=this.config.warnings||{};return[...Object.keys(t).filter(t=>this.result.tags.includes(t)).map(e=>t[e]),...this.forcedWarnings]}toID(...t){return this.result?["result",this.result.id,...t].join("-"):""}toMediaViewer(){let t=(t,e)=>(t.preventDefault(),t.stopPropagation(),this.config.mediaIndex+=e,this.config.onChange(this),!1),e=this.config.mediaIndex>0,i=this.config.mediaIndex<this.result.media.length-1,s=this.result.media[this.config.mediaIndex];return function(){var t=require("/Users/phx/Sync/sign-search/node_modules/nanohtml/lib/append-child.js"),e=document.createElement("div");e.setAttribute("data-nanomorph-component-id",arguments[8]+"/media/"+arguments[9]),e.setAttribute("class","video_player");var i=document.createElement("picture");i.setAttribute("aria-hidden","true"),i.setAttribute("class","video_thumb");var s=document.createElement("video");s.setAttribute("muted","muted"),s.setAttribute("preload","preload"),s.setAttribute("autoplay","autoplay"),s.setAttribute("loop","loop"),s.setAttribute("playsinline","playsinline"),s.setAttribute("class","video_thumb"),t(s,["\n          ",arguments[0],"\n        "]),t(i,["\n        ",arguments[1],"\n        ",s,"\n      "]);var n=document.createElement("button");n.setAttribute("aria-label","Previous Video"),n.onclick=arguments[2],n.setAttribute("style",arguments[3]),n.setAttribute("class","prev_vid"),t(n,[arguments[4]]);var r=document.createElement("button");return r.setAttribute("aria-label","Next Video"),r.onclick=arguments[5],r.setAttribute("style",arguments[6]),r.setAttribute("class","next_vid"),t(r,[arguments[7]]),t(e,["\n      ",i,"\n      ",n,"\n      ",r,"\n    "]),e}(s.map(t=>(function(){var t=document.createElement("source");return t.setAttribute("src",arguments[0]),t.setAttribute("type",arguments[1]),t})(t.url,t.type)),s.map(t=>(function(){var t=document.createElement("source");return t.setAttribute("srcset",arguments[0]),t.setAttribute("type",arguments[1]),t})(t.url,t.type)),e=>t(e,-1),e?"":"display: none","❮",e=>t(e,1),i?"":"display: none","❯",this.result.id,this.config.mediaIndex)}toPopulatedHTML(){return function(){var t=require("/Users/phx/Sync/sign-search/node_modules/nanohtml/lib/append-child.js"),e=document.createElement("a");e.setAttribute("href",arguments[5]),e.setAttribute("referrerpolicy","origin"),e.setAttribute("rel","external"),e.setAttribute("id",arguments[6]),e.setAttribute("aria-labelledby",arguments[7]),e.setAttribute("role","link"),e.setAttribute("class","result "+arguments[8]);var i=document.createElement("h2");i.setAttribute("id",arguments[0]),i.setAttribute("class","keywords"),t(i,[arguments[1]]);var s=document.createElement("cite");s.setAttribute("class","link"),t(s,[arguments[2]]);var n=document.createElement("div");n.setAttribute("class","tags"),t(n,[arguments[3]]);var r=document.createElement("div");return r.setAttribute("class","mini_def"),t(r,[arguments[4]]),t(e,["\n      ",arguments[9],"\n      ",i,"\n      ",s,"\n      ",n,"\n      ",arguments[10],"\n      ",r,"\n    "]),e}(this.toID("keywords"),this.result.title||this.result.keywords.join(", "),this.result.link,this.result.tags.map(t=>`#${t}`).join(" "),this.result.body,this.result.link,this.toID(),this.toID("keywords"),this.getWarnings().map(t=>t.type).join(" "),this.toMediaViewer(),this.getWarnings().map(t=>(function(){var t=require("/Users/phx/Sync/sign-search/node_modules/nanohtml/lib/append-child.js"),e=document.createElement("div");return e.setAttribute("class","alert "+arguments[0]),t(e,[arguments[1]]),e})(t.type,t.text)))}toPlaceholderHTML(){return function(){var t=document.createElement("a");return t.setAttribute("aria-hidden","true"),t.setAttribute("class","result placeholder "+arguments[0]),t}(this.getWarnings().map(t=>t.type).join(" "))}}module.exports=SearchResultPanel;

},{"/Users/phx/Sync/sign-search/node_modules/nanohtml/lib/append-child.js":31}],5:[function(require,module,exports){
...
},{"../util":10,"borc":20,"buffer":24}],12:[function(require,module,exports){
...
},{"bignumber.js":14}],16:[function(require,module,exports){
...
},{"./constants":15,"./decoder.asm":16,"./simple":21,"./tagged":22,"./utils":23,"bignumber.js":14,"buffer":24,"ieee754":26,"iso-url":27}],18:[function(require,module,exports){
(function (Buffer){
'use strict'
...
},{"./decoder":17,"./utils":23,"buffer":24}],19:[function(require,module,exports){
(function (Buffer){
'use strict'
...
},{"./constants":15,"./utils":23,"bignumber.js":14,"buffer":24,"iso-url":27}],20:[function(require,module,exports){
'use strict'
...
},{"./constants":15,"bignumber.js":14,"buffer":24}],24:[function(require,module,exports){
(function (Buffer){
/*!
...
},{"base64-js":13,"buffer":24,"ieee754":26}],25:[function(require,module,exports){
'use strict';
...
},{"./src/relative":28,"./src/url":29}],28:[function(require,module,exports){
'use strict';
...
},{"./url":29}],29:[function(require,module,exports){
'use strict';
...
},{"./lib/morph":34,"nanoassert":30}],33:[function(require,module,exports){
module.exports = [
